  ...
  return (
    <div className="relative top-24 z-10 text-white">
          ...
          <div className="relative flex items-center justify-center flex-col lg:flex-row lg:justify-between lg:gap-20">
            ...
            <div className="flex flex-col  gap-3 max-w-[500px] ">
              <h2 className="text-2xl font-semibold uppercase md:text-start text-center p-5 md:px-0 lg:text-3xl">
                {data.title} <br /> <span className="text-sm font-normal"> {data.tagline==="" ? null : "(" + data.tagline + ")"} </span>
              </h2>
              <div className="flex justify-between">
                ...
                <h2 className="">Runtime: {data.runtime} Mins</h2>
              </div>
              ...
              <a
                href={"https://www.imdb.com/title/" + data.imdb_id} target="/blank"
                className="mt-5 md:mt-2 w-fit px-2 py-2 md:px-6 md:py-2 font-semibold text-black bg-[#deb522] flex items-center gap-1"
              >
      ...
      <div className="flex justify-center p-5 flex-col">
        <h2 className="font-semibold py-5">Movie Teaser:</h2>
        <div className="p-2 bg-white w-fit">
          <Trailer idvalue={title} />
        </div>
      </div>
      <div>
        <RelatedContent idData={title} textValue={"Movies"}/>
      </div>
    </div>
  );
};
